...
#import "LocationStreamController.h"
...
@interface LocationStreamController ()

@end

@implementation LocationStreamController
...
//    NSString *input_str = [[NSBundle mainBundle] pathForResource:@"test.mp4" ofType:nil];
    NSString *input_str = @"http://wvideo.spriteapp.cn/video/2016/0328/56f8ec01d9bfe_wpd.mp4";
